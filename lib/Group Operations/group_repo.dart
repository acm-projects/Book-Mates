...
Future createOrUpdate(String bookName, String groupName, String userEmail,
  ...
  await docRef.set({
    ...
    'memberCount': 0,
    'profPicURL':
        "https://firebasestorage.googleapis.com/v0/b/bookma-d79ce.appspot.com/o/question.jpg?alt=media&token=f62ba153-6a1f-40d1-8db5-5e6cc6394a62", // Store the book cover URL here
  });
